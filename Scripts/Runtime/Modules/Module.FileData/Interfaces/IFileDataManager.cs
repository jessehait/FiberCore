...
namespace Fiber
{
    public interface IFileDataManager
    {
        ...
        void RegisterType<T>() where T : BaseFileData, new();
        ...
        bool GetData<T>(out T data) where T : BaseFileData;
        ...
        T GetData<T>() where T : BaseFileData;

        /// <summary>
        /// Get list of saved data files
        /// </summary>
        /// <param name="data">Data reference</param>
        bool GetSaveList(out IFileData[] data);
        ...
        /// </summary>
        /// <typeparam name="T">Data type</typeparam>
        void Reset<T>() where T : BaseFileData, new();
